cdef extern from "cimgui/cimgui.h":
    ...
    cdef struct ImGuiIO:
        ...
        const char*(*)(void* user_data) GetClipboardTextFn
        void(*)(void* user_data,const char* text) SetClipboardTextFn
        void* ClipboardUserData
        void(*)(int x,int y) ImeSetInputScreenPosFn
    ...
    cpdef const ImFontAtlasCustomRect* GetCustomRectByIndex(ImFontAtlas* self,int index)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesChineseFull
    cpdef const ImWchar* GetGlyphRangesChineseFull(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon
    cpdef const ImWchar* GetGlyphRangesChineseSimplifiedCommon(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesCyrillic
    cpdef const ImWchar* GetGlyphRangesCyrillic(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesDefault
    cpdef const ImWchar* GetGlyphRangesDefault(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesJapanese
    cpdef const ImWchar* GetGlyphRangesJapanese(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesKorean
    cpdef const ImWchar* GetGlyphRangesKorean(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesThai
    cpdef const ImWchar* GetGlyphRangesThai(ImFontAtlas* self)
    pass
    
    #Autogenerated for ImFontAtlas_GetGlyphRangesVietnamese
    cpdef const ImWchar* GetGlyphRangesVietnamese(ImFontAtlas* self)
    pass
    ...
    cpdef const char* CalcWordWrapPositionA(ImFont* self,float scale,const char* text,const char* text_end,float wrap_width)
    pass
    ...
    cpdef const ImFontGlyph* FindGlyph(ImFont* self,ImWchar c)
    pass
    
    #Autogenerated for ImFont_FindGlyphNoFallback
    cpdef const ImFontGlyph* FindGlyphNoFallback(ImFont* self,ImWchar c)
    pass
    ...
    cpdef const char* GetDebugName(ImFont* self)
    pass
    ...
    cpdef const char* begin(ImGuiTextBuffer* self)
    pass
    
    #Autogenerated for ImGuiTextBuffer_c_str
    cpdef const char* c_str(ImGuiTextBuffer* self)
    pass
    ...
    cpdef const char* end(ImGuiTextBuffer* self)
    pass
    ...
    cpdef ImDrawChannel const * back(const ImVector_ImDrawChannel* self)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_begin
    cpdef ImDrawChannel* begin(ImVector_ImDrawChannel* self)
    cpdef ImDrawChannel const * begin(const ImVector_ImDrawChannel* self)
    pass
    ...
    cpdef ImDrawChannel const * end(const ImVector_ImDrawChannel* self)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_erase
    cpdef ImDrawChannel* erase(ImVector_ImDrawChannel* self,ImDrawChannel const * it)
    cpdef ImDrawChannel* erase(ImVector_ImDrawChannel* self,ImDrawChannel const * it,ImDrawChannel const * it_last)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_erase_unsorted
    cpdef ImDrawChannel* erase_unsorted(ImVector_ImDrawChannel* self,ImDrawChannel const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_front
    cpdef ImDrawChannel* front(ImVector_ImDrawChannel* self)
    cpdef ImDrawChannel const * front(const ImVector_ImDrawChannel* self)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImDrawChannel* self,ImDrawChannel const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawChannel_insert
    cpdef ImDrawChannel* insert(ImVector_ImDrawChannel* self,ImDrawChannel const * it,const ImDrawChannel v)
    pass
    ...
    cpdef ImDrawCmd const * back(const ImVector_ImDrawCmd* self)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_begin
    cpdef ImDrawCmd* begin(ImVector_ImDrawCmd* self)
    cpdef ImDrawCmd const * begin(const ImVector_ImDrawCmd* self)
    pass
    ...
    cpdef ImDrawCmd const * end(const ImVector_ImDrawCmd* self)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_erase
    cpdef ImDrawCmd* erase(ImVector_ImDrawCmd* self,ImDrawCmd const * it)
    cpdef ImDrawCmd* erase(ImVector_ImDrawCmd* self,ImDrawCmd const * it,ImDrawCmd const * it_last)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_erase_unsorted
    cpdef ImDrawCmd* erase_unsorted(ImVector_ImDrawCmd* self,ImDrawCmd const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_front
    cpdef ImDrawCmd* front(ImVector_ImDrawCmd* self)
    cpdef ImDrawCmd const * front(const ImVector_ImDrawCmd* self)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImDrawCmd* self,ImDrawCmd const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawCmd_insert
    cpdef ImDrawCmd* insert(ImVector_ImDrawCmd* self,ImDrawCmd const * it,const ImDrawCmd v)
    pass
    ...
    cpdef ImDrawIdx const * back(const ImVector_ImDrawIdx* self)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_begin
    cpdef ImDrawIdx* begin(ImVector_ImDrawIdx* self)
    cpdef ImDrawIdx const * begin(const ImVector_ImDrawIdx* self)
    pass
    ...
    cpdef ImDrawIdx const * end(const ImVector_ImDrawIdx* self)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_erase
    cpdef ImDrawIdx* erase(ImVector_ImDrawIdx* self,ImDrawIdx const * it)
    cpdef ImDrawIdx* erase(ImVector_ImDrawIdx* self,ImDrawIdx const * it,ImDrawIdx const * it_last)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_erase_unsorted
    cpdef ImDrawIdx* erase_unsorted(ImVector_ImDrawIdx* self,ImDrawIdx const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_front
    cpdef ImDrawIdx* front(ImVector_ImDrawIdx* self)
    cpdef ImDrawIdx const * front(const ImVector_ImDrawIdx* self)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImDrawIdx* self,ImDrawIdx const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawIdx_insert
    cpdef ImDrawIdx* insert(ImVector_ImDrawIdx* self,ImDrawIdx const * it,const ImDrawIdx v)
    pass
    ...
    cpdef ImDrawVert const * back(const ImVector_ImDrawVert* self)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_begin
    cpdef ImDrawVert* begin(ImVector_ImDrawVert* self)
    cpdef ImDrawVert const * begin(const ImVector_ImDrawVert* self)
    pass
    ...
    cpdef ImDrawVert const * end(const ImVector_ImDrawVert* self)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_erase
    cpdef ImDrawVert* erase(ImVector_ImDrawVert* self,ImDrawVert const * it)
    cpdef ImDrawVert* erase(ImVector_ImDrawVert* self,ImDrawVert const * it,ImDrawVert const * it_last)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_erase_unsorted
    cpdef ImDrawVert* erase_unsorted(ImVector_ImDrawVert* self,ImDrawVert const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_front
    cpdef ImDrawVert* front(ImVector_ImDrawVert* self)
    cpdef ImDrawVert const * front(const ImVector_ImDrawVert* self)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImDrawVert* self,ImDrawVert const * it)
    pass
    
    #Autogenerated for ImVector_ImDrawVert_insert
    cpdef ImDrawVert* insert(ImVector_ImDrawVert* self,ImDrawVert const * it,const ImDrawVert v)
    pass
    ...
    cpdef ImFontAtlasCustomRect const * back(const ImVector_ImFontAtlasCustomRect* self)
    pass
    ...
    cpdef ImFontAtlasCustomRect const * begin(const ImVector_ImFontAtlasCustomRect* self)
    pass
    ...
    cpdef ImFontAtlasCustomRect const * end(const ImVector_ImFontAtlasCustomRect* self)
    pass
    
    #Autogenerated for ImVector_ImFontAtlasCustomRect_erase
    cpdef ImFontAtlasCustomRect* erase(ImVector_ImFontAtlasCustomRect* self,ImFontAtlasCustomRect const * it)
    cpdef ImFontAtlasCustomRect* erase(ImVector_ImFontAtlasCustomRect* self,ImFontAtlasCustomRect const * it,ImFontAtlasCustomRect const * it_last)
    pass
    
    #Autogenerated for ImVector_ImFontAtlasCustomRect_erase_unsorted
    cpdef ImFontAtlasCustomRect* erase_unsorted(ImVector_ImFontAtlasCustomRect* self,ImFontAtlasCustomRect const * it)
    pass
    ...
    cpdef ImFontAtlasCustomRect const * front(const ImVector_ImFontAtlasCustomRect* self)
    pass
    
    #Autogenerated for ImVector_ImFontAtlasCustomRect_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImFontAtlasCustomRect* self,ImFontAtlasCustomRect const * it)
    pass
    
    #Autogenerated for ImVector_ImFontAtlasCustomRect_insert
    cpdef ImFontAtlasCustomRect* insert(ImVector_ImFontAtlasCustomRect* self,ImFontAtlasCustomRect const * it,const ImFontAtlasCustomRect v)
    pass
    ...
    cpdef ImFontConfig const * back(const ImVector_ImFontConfig* self)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_begin
    cpdef ImFontConfig* begin(ImVector_ImFontConfig* self)
    cpdef ImFontConfig const * begin(const ImVector_ImFontConfig* self)
    pass
    ...
    cpdef ImFontConfig const * end(const ImVector_ImFontConfig* self)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_erase
    cpdef ImFontConfig* erase(ImVector_ImFontConfig* self,ImFontConfig const * it)
    cpdef ImFontConfig* erase(ImVector_ImFontConfig* self,ImFontConfig const * it,ImFontConfig const * it_last)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_erase_unsorted
    cpdef ImFontConfig* erase_unsorted(ImVector_ImFontConfig* self,ImFontConfig const * it)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_front
    cpdef ImFontConfig* front(ImVector_ImFontConfig* self)
    cpdef ImFontConfig const * front(const ImVector_ImFontConfig* self)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImFontConfig* self,ImFontConfig const * it)
    pass
    
    #Autogenerated for ImVector_ImFontConfig_insert
    cpdef ImFontConfig* insert(ImVector_ImFontConfig* self,ImFontConfig const * it,const ImFontConfig v)
    pass
    ...
    cpdef ImFontGlyph const * back(const ImVector_ImFontGlyph* self)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_begin
    cpdef ImFontGlyph* begin(ImVector_ImFontGlyph* self)
    cpdef ImFontGlyph const * begin(const ImVector_ImFontGlyph* self)
    pass
    ...
    cpdef ImFontGlyph const * end(const ImVector_ImFontGlyph* self)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_erase
    cpdef ImFontGlyph* erase(ImVector_ImFontGlyph* self,ImFontGlyph const * it)
    cpdef ImFontGlyph* erase(ImVector_ImFontGlyph* self,ImFontGlyph const * it,ImFontGlyph const * it_last)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_erase_unsorted
    cpdef ImFontGlyph* erase_unsorted(ImVector_ImFontGlyph* self,ImFontGlyph const * it)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_front
    cpdef ImFontGlyph* front(ImVector_ImFontGlyph* self)
    cpdef ImFontGlyph const * front(const ImVector_ImFontGlyph* self)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImFontGlyph* self,ImFontGlyph const * it)
    pass
    
    #Autogenerated for ImVector_ImFontGlyph_insert
    cpdef ImFontGlyph* insert(ImVector_ImFontGlyph* self,ImFontGlyph const * it,const ImFontGlyph v)
    pass
    ...
    cpdef ImFont* const * back(const ImVector_ImFontPtr* self)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_begin
    cpdef ImFont** begin(ImVector_ImFontPtr* self)
    cpdef ImFont* const * begin(const ImVector_ImFontPtr* self)
    pass
    ...
    cpdef ImFont* const * end(const ImVector_ImFontPtr* self)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_erase
    cpdef ImFont** erase(ImVector_ImFontPtr* self,ImFont* const * it)
    cpdef ImFont** erase(ImVector_ImFontPtr* self,ImFont* const * it,ImFont* const * it_last)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_erase_unsorted
    cpdef ImFont** erase_unsorted(ImVector_ImFontPtr* self,ImFont* const * it)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_front
    cpdef ImFont** front(ImVector_ImFontPtr* self)
    cpdef ImFont* const * front(const ImVector_ImFontPtr* self)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImFontPtr* self,ImFont* const * it)
    pass
    
    #Autogenerated for ImVector_ImFontPtr_insert
    cpdef ImFont** insert(ImVector_ImFontPtr* self,ImFont* const * it,ImFont* const  v)
    pass
    ...
    cpdef ImGuiStoragePair const * back(const ImVector_ImGuiStoragePair* self)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_begin
    cpdef ImGuiStoragePair* begin(ImVector_ImGuiStoragePair* self)
    cpdef ImGuiStoragePair const * begin(const ImVector_ImGuiStoragePair* self)
    pass
    ...
    cpdef ImGuiStoragePair const * end(const ImVector_ImGuiStoragePair* self)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_erase
    cpdef ImGuiStoragePair* erase(ImVector_ImGuiStoragePair* self,ImGuiStoragePair const * it)
    cpdef ImGuiStoragePair* erase(ImVector_ImGuiStoragePair* self,ImGuiStoragePair const * it,ImGuiStoragePair const * it_last)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_erase_unsorted
    cpdef ImGuiStoragePair* erase_unsorted(ImVector_ImGuiStoragePair* self,ImGuiStoragePair const * it)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_front
    cpdef ImGuiStoragePair* front(ImVector_ImGuiStoragePair* self)
    cpdef ImGuiStoragePair const * front(const ImVector_ImGuiStoragePair* self)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImGuiStoragePair* self,ImGuiStoragePair const * it)
    pass
    
    #Autogenerated for ImVector_ImGuiStoragePair_insert
    cpdef ImGuiStoragePair* insert(ImVector_ImGuiStoragePair* self,ImGuiStoragePair const * it,const ImGuiStoragePair v)
    pass
    ...
    cpdef ImGuiTextRange const * back(const ImVector_ImGuiTextRange* self)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_begin
    cpdef ImGuiTextRange* begin(ImVector_ImGuiTextRange* self)
    cpdef ImGuiTextRange const * begin(const ImVector_ImGuiTextRange* self)
    pass
    ...
    cpdef ImGuiTextRange const * end(const ImVector_ImGuiTextRange* self)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_erase
    cpdef ImGuiTextRange* erase(ImVector_ImGuiTextRange* self,ImGuiTextRange const * it)
    cpdef ImGuiTextRange* erase(ImVector_ImGuiTextRange* self,ImGuiTextRange const * it,ImGuiTextRange const * it_last)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_erase_unsorted
    cpdef ImGuiTextRange* erase_unsorted(ImVector_ImGuiTextRange* self,ImGuiTextRange const * it)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_front
    cpdef ImGuiTextRange* front(ImVector_ImGuiTextRange* self)
    cpdef ImGuiTextRange const * front(const ImVector_ImGuiTextRange* self)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImGuiTextRange* self,ImGuiTextRange const * it)
    pass
    
    #Autogenerated for ImVector_ImGuiTextRange_insert
    cpdef ImGuiTextRange* insert(ImVector_ImGuiTextRange* self,ImGuiTextRange const * it,const ImGuiTextRange v)
    pass
    ...
    cpdef ImTextureID const * back(const ImVector_ImTextureID* self)
    pass
    
    #Autogenerated for ImVector_ImTextureID_begin
    cpdef ImTextureID* begin(ImVector_ImTextureID* self)
    cpdef ImTextureID const * begin(const ImVector_ImTextureID* self)
    pass
    ...
    cpdef ImTextureID const * end(const ImVector_ImTextureID* self)
    pass
    
    #Autogenerated for ImVector_ImTextureID_erase
    cpdef ImTextureID* erase(ImVector_ImTextureID* self,ImTextureID const * it)
    cpdef ImTextureID* erase(ImVector_ImTextureID* self,ImTextureID const * it,ImTextureID const * it_last)
    pass
    
    #Autogenerated for ImVector_ImTextureID_erase_unsorted
    cpdef ImTextureID* erase_unsorted(ImVector_ImTextureID* self,ImTextureID const * it)
    pass
    
    #Autogenerated for ImVector_ImTextureID_front
    cpdef ImTextureID* front(ImVector_ImTextureID* self)
    cpdef ImTextureID const * front(const ImVector_ImTextureID* self)
    pass
    
    #Autogenerated for ImVector_ImTextureID_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImTextureID* self,ImTextureID const * it)
    pass
    
    #Autogenerated for ImVector_ImTextureID_insert
    cpdef ImTextureID* insert(ImVector_ImTextureID* self,ImTextureID const * it,const ImTextureID v)
    pass
    ...
    cpdef ImU32 const * back(const ImVector_ImU32* self)
    pass
    
    #Autogenerated for ImVector_ImU32_begin
    cpdef ImU32* begin(ImVector_ImU32* self)
    cpdef ImU32 const * begin(const ImVector_ImU32* self)
    pass
    ...
    cpdef ImU32 const * end(const ImVector_ImU32* self)
    pass
    
    #Autogenerated for ImVector_ImU32_erase
    cpdef ImU32* erase(ImVector_ImU32* self,ImU32 const * it)
    cpdef ImU32* erase(ImVector_ImU32* self,ImU32 const * it,ImU32 const * it_last)
    pass
    
    #Autogenerated for ImVector_ImU32_erase_unsorted
    cpdef ImU32* erase_unsorted(ImVector_ImU32* self,ImU32 const * it)
    pass
    
    #Autogenerated for ImVector_ImU32_front
    cpdef ImU32* front(ImVector_ImU32* self)
    cpdef ImU32 const * front(const ImVector_ImU32* self)
    pass
    
    #Autogenerated for ImVector_ImU32_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImU32* self,ImU32 const * it)
    pass
    
    #Autogenerated for ImVector_ImU32_insert
    cpdef ImU32* insert(ImVector_ImU32* self,ImU32 const * it,const ImU32 v)
    pass
    ...
    cpdef ImVec2 const * back(const ImVector_ImVec2* self)
    pass
    
    #Autogenerated for ImVector_ImVec2_begin
    cpdef ImVec2* begin(ImVector_ImVec2* self)
    cpdef ImVec2 const * begin(const ImVector_ImVec2* self)
    pass
    ...
    cpdef ImVec2 const * end(const ImVector_ImVec2* self)
    pass
    
    #Autogenerated for ImVector_ImVec2_erase
    cpdef ImVec2* erase(ImVector_ImVec2* self,ImVec2 const * it)
    cpdef ImVec2* erase(ImVector_ImVec2* self,ImVec2 const * it,ImVec2 const * it_last)
    pass
    
    #Autogenerated for ImVector_ImVec2_erase_unsorted
    cpdef ImVec2* erase_unsorted(ImVector_ImVec2* self,ImVec2 const * it)
    pass
    
    #Autogenerated for ImVector_ImVec2_front
    cpdef ImVec2* front(ImVector_ImVec2* self)
    cpdef ImVec2 const * front(const ImVector_ImVec2* self)
    pass
    
    #Autogenerated for ImVector_ImVec2_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImVec2* self,ImVec2 const * it)
    pass
    
    #Autogenerated for ImVector_ImVec2_insert
    cpdef ImVec2* insert(ImVector_ImVec2* self,ImVec2 const * it,const ImVec2 v)
    pass
    ...
    cpdef ImVec4 const * back(const ImVector_ImVec4* self)
    pass
    
    #Autogenerated for ImVector_ImVec4_begin
    cpdef ImVec4* begin(ImVector_ImVec4* self)
    cpdef ImVec4 const * begin(const ImVector_ImVec4* self)
    pass
    ...
    cpdef ImVec4 const * end(const ImVector_ImVec4* self)
    pass
    
    #Autogenerated for ImVector_ImVec4_erase
    cpdef ImVec4* erase(ImVector_ImVec4* self,ImVec4 const * it)
    cpdef ImVec4* erase(ImVector_ImVec4* self,ImVec4 const * it,ImVec4 const * it_last)
    pass
    
    #Autogenerated for ImVector_ImVec4_erase_unsorted
    cpdef ImVec4* erase_unsorted(ImVector_ImVec4* self,ImVec4 const * it)
    pass
    
    #Autogenerated for ImVector_ImVec4_front
    cpdef ImVec4* front(ImVector_ImVec4* self)
    cpdef ImVec4 const * front(const ImVector_ImVec4* self)
    pass
    
    #Autogenerated for ImVector_ImVec4_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImVec4* self,ImVec4 const * it)
    pass
    
    #Autogenerated for ImVector_ImVec4_insert
    cpdef ImVec4* insert(ImVector_ImVec4* self,ImVec4 const * it,const ImVec4 v)
    pass
    ...
    cpdef ImWchar const * back(const ImVector_ImWchar* self)
    pass
    
    #Autogenerated for ImVector_ImWchar_begin
    cpdef ImWchar* begin(ImVector_ImWchar* self)
    cpdef ImWchar const * begin(const ImVector_ImWchar* self)
    pass
    ...
    cpdef ImWchar const * end(const ImVector_ImWchar* self)
    pass
    
    #Autogenerated for ImVector_ImWchar_erase
    cpdef ImWchar* erase(ImVector_ImWchar* self,ImWchar const * it)
    cpdef ImWchar* erase(ImVector_ImWchar* self,ImWchar const * it,ImWchar const * it_last)
    pass
    
    #Autogenerated for ImVector_ImWchar_erase_unsorted
    cpdef ImWchar* erase_unsorted(ImVector_ImWchar* self,ImWchar const * it)
    pass
    
    #Autogenerated for ImVector_ImWchar_front
    cpdef ImWchar* front(ImVector_ImWchar* self)
    cpdef ImWchar const * front(const ImVector_ImWchar* self)
    pass
    
    #Autogenerated for ImVector_ImWchar_index_from_ptr
    cpdef int index_from_ptr(const ImVector_ImWchar* self,ImWchar const * it)
    pass
    
    #Autogenerated for ImVector_ImWchar_insert
    cpdef ImWchar* insert(ImVector_ImWchar* self,ImWchar const * it,const ImWchar v)
    pass
    ...
    cpdef const T* back(ImVector* self)
    pass
    
    #Autogenerated for ImVector_begin
    cpdef T* begin(ImVector* self)
    cpdef const T* begin(ImVector* self)
    pass
    ...
    cpdef char const * back(const ImVector_char* self)
    pass
    
    #Autogenerated for ImVector_char_begin
    cpdef char* begin(ImVector_char* self)
    cpdef char const * begin(const ImVector_char* self)
    pass
    ...
    cpdef char const * end(const ImVector_char* self)
    pass
    
    #Autogenerated for ImVector_char_erase
    cpdef char* erase(ImVector_char* self,char const * it)
    cpdef char* erase(ImVector_char* self,char const * it,char const * it_last)
    pass
    
    #Autogenerated for ImVector_char_erase_unsorted
    cpdef char* erase_unsorted(ImVector_char* self,char const * it)
    pass
    
    #Autogenerated for ImVector_char_front
    cpdef char* front(ImVector_char* self)
    cpdef char const * front(const ImVector_char* self)
    pass
    
    #Autogenerated for ImVector_char_index_from_ptr
    cpdef int index_from_ptr(const ImVector_char* self,char const * it)
    pass
    
    #Autogenerated for ImVector_char_insert
    cpdef char* insert(ImVector_char* self,char const * it,const char v)
    pass
    ...
    cpdef const T* end(ImVector* self)
    pass
    ...
    cpdef float const * back(const ImVector_float* self)
    pass
    
    #Autogenerated for ImVector_float_begin
    cpdef float* begin(ImVector_float* self)
    cpdef float const * begin(const ImVector_float* self)
    pass
    ...
    cpdef float const * end(const ImVector_float* self)
    pass
    
    #Autogenerated for ImVector_float_erase
    cpdef float* erase(ImVector_float* self,float const * it)
    cpdef float* erase(ImVector_float* self,float const * it,float const * it_last)
    pass
    
    #Autogenerated for ImVector_float_erase_unsorted
    cpdef float* erase_unsorted(ImVector_float* self,float const * it)
    pass
    
    #Autogenerated for ImVector_float_front
    cpdef float* front(ImVector_float* self)
    cpdef float const * front(const ImVector_float* self)
    pass
    
    #Autogenerated for ImVector_float_index_from_ptr
    cpdef int index_from_ptr(const ImVector_float* self,float const * it)
    pass
    
    #Autogenerated for ImVector_float_insert
    cpdef float* insert(ImVector_float* self,float const * it,const float v)
    pass
    ...
    cpdef const T* front(ImVector* self)
    pass
    ...
    cpdef const ImGuiPayload* AcceptDragDropPayload(const char* type,ImGuiDragDropFlags flags)
    pass
    ...
    cpdef ImU32 ColorConvertFloat4ToU32(const ImVec4 in)
    pass
    ...
    cpdef ImVec4 ColorConvertU32ToFloat4(ImU32 in)
    cpdef void ColorConvertU32ToFloat4(ImVec4 *pOut,ImU32 in)
    cpdef ImVec4_Simple ColorConvertU32ToFloat4(ImU32 in)
    pass
    ...
    cpdef const char* GetClipboardText()
    pass
    ...
    cpdef const ImGuiPayload* GetDragDropPayload()
    pass
    ...
    cpdef const char* GetStyleColorName(ImGuiCol idx)
    pass
    
    #Autogenerated for igGetStyleColorVec4
    cpdef const ImVec4* GetStyleColorVec4(ImGuiCol idx)
    pass
    ...
    cpdef const char* SaveIniSettingsToMemory(size_t* out_ini_size)
    pass
    ...
    ctypedef ImColor struct ImColor
    ctypedef ImDrawCallback void(*)(const ImDrawList* parent_list,const ImDrawCmd* cmd);
    ctypedef ImDrawChannel struct ImDrawChannel
    ctypedef ImDrawCmd struct ImDrawCmd
    ctypedef ImDrawCornerFlags int
    ctypedef ImDrawData struct ImDrawData
    ctypedef ImDrawIdx unsigned short
    ctypedef ImDrawList struct ImDrawList
    ctypedef ImDrawListFlags int
    ctypedef ImDrawListSharedData struct ImDrawListSharedData
    ctypedef ImDrawListSplitter struct ImDrawListSplitter
    ctypedef ImDrawVert struct ImDrawVert
    ctypedef ImFont struct ImFont
    ctypedef ImFontAtlas struct ImFontAtlas
    ctypedef ImFontAtlasCustomRect struct ImFontAtlasCustomRect
    ctypedef ImFontAtlasFlags int
    ctypedef ImFontConfig struct ImFontConfig
    ctypedef ImFontGlyph struct ImFontGlyph
    ctypedef ImFontGlyphRangesBuilder struct ImFontGlyphRangesBuilder
    ctypedef ImGuiBackendFlags int
    ctypedef ImGuiCol int
    ctypedef ImGuiColorEditFlags int
    ctypedef ImGuiComboFlags int
    ctypedef ImGuiCond int
    ctypedef ImGuiConfigFlags int
    ctypedef ImGuiContext struct ImGuiContext
    ctypedef ImGuiDataType int
    ctypedef ImGuiDir int
    ctypedef ImGuiDragDropFlags int
    ctypedef ImGuiFocusedFlags int
    ctypedef ImGuiHoveredFlags int
    ctypedef ImGuiID unsigned int
    ctypedef ImGuiIO struct ImGuiIO
    ctypedef ImGuiInputTextCallback int(*)(ImGuiInputTextCallbackData *data);
    ctypedef ImGuiInputTextCallbackData struct ImGuiInputTextCallbackData
    ctypedef ImGuiInputTextFlags int
    ctypedef ImGuiKey int
    ctypedef ImGuiListClipper struct ImGuiListClipper
    ctypedef ImGuiMouseCursor int
    ctypedef ImGuiNavInput int
    ctypedef ImGuiOnceUponAFrame struct ImGuiOnceUponAFrame
    ctypedef ImGuiPayload struct ImGuiPayload
    ctypedef ImGuiSelectableFlags int
    ctypedef ImGuiSizeCallback void(*)(ImGuiSizeCallbackData* data);
    ctypedef ImGuiSizeCallbackData struct ImGuiSizeCallbackData
    ctypedef ImGuiStorage struct ImGuiStorage
    ctypedef ImGuiStoragePair struct ImGuiStoragePair
    ctypedef ImGuiStyle struct ImGuiStyle
    ctypedef ImGuiStyleVar int
    ctypedef ImGuiTabBarFlags int
    ctypedef ImGuiTabItemFlags int
    ctypedef ImGuiTextBuffer struct ImGuiTextBuffer
    ctypedef ImGuiTextFilter struct ImGuiTextFilter
    ctypedef ImGuiTextRange struct ImGuiTextRange
    ctypedef ImGuiTreeNodeFlags int
    ctypedef ImGuiWindowFlags int
    ctypedef ImS16 signed short
    ctypedef ImS32 signed int
    ctypedef ImS64 int64_t
    ctypedef ImS8 signed char
    ctypedef ImTextureID void*
    ctypedef ImU16 unsigned short
    ctypedef ImU32 unsigned int
    ctypedef ImU64 uint64_t
    ctypedef ImU8 unsigned char
    ctypedef ImVec2 struct ImVec2
    ctypedef ImVec4 struct ImVec4
    ctypedef ImWchar unsigned short
    ctypedef const_iterator const value_type*
    ctypedef iterator value_type*
    ctypedef value_type T
